...
export function formatProductPrice(product) {
  ...
  if (!price || price <= 0) return "Price on enquiry";
  return formatPrice(price);
}

export function isEnquiryProduct(product) {
  const price = getEffectivePrice(product);
...
export const BUSINESS = {
  ...
  email: "ommosquitonets2@gmail.com",
  phone: "090642 44204",
  ...
  youtube: "https://www.youtube.com/@ommosquitonets",
  whatsapp: "https://wa.me/919064244204",
  facebook:"https://www.facebook.com/profile.php?id=61554801984854",
  whatsappDefaultMessage:
    "Hi Om Mosquito Nets! I would like to enquire about your mosquito nets, curtains, or installation services.",
};

export function getWhatsAppLink(message = BUSINESS.whatsappDefaultMessage) {
